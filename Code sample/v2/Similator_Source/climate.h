...
public slots:
    ...
    double getTemp_outside();
    void setData(double temp_driver, double temp_passenger,double temp_outside, int fan_speed, int driver_wind_mode, int passenger_wind_mode, int auto_mode, int sync_mode);
